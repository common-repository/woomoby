		...
		public function init() {
			...
			$this->strings = array(
				...
				'notice_can_install_required'     => _n_noop(
					...
					'Woomoby requires the following plugin: %1$s.',
					'Woomoby requires the following plugins: %1$s.',
					'tgmpa'
				),
				'notice_can_install_recommended'  => _n_noop(
					/* translators: 1: plugin name(s). */
					'Woomoby recommends the following plugin: %1$s.',
					'Woomoby recommends the following plugins: %1$s.',
					'tgmpa'
				),
				'notice_ask_to_update'            => _n_noop(
					/* translators: 1: plugin name(s). */
					'The following plugin needs to be updated to its latest version to ensure maximum compatibility with Woomoby: %1$s.',
					'The following plugins need to be updated to their latest version to ensure maximum compatibility with Woomoby: %1$s.',
					'tgmpa'
				),
